...
ری‌سایفر یک ابزار ساده و تحت وب برای فشرده‌سازی و رمزگذاری متن است. این ابزار برای Encode و Decode کانفیگ‌های شبکه مثل V2Ray و WireGuard طراحی شده و خروجی را به‌صورت کاملاً فارسی تولید می‌کند تا برای ارسال از طریق پیامک یا پیام‌رسان‌ها مناسب باشد.
